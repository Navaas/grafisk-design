  ...
  return (
    ...
    >
      <div className="bg-white bg-opacity-40 w-2/3 xl:w-1/2 flex flex-col justify-center items-center p-6 fade-in">
        ...
        <button className="bg-[#FAA916] text-white py-4 px-4 xl:w-1/3 m-2 uppercase drop-shadow-xl hover:opacity-80 transform hover:scale-110 transition-transform duration-100 text-font">
          Boka nu
        </button>
      </div>
    </div>
